...
apt-get install sudo wget nano curl mariadb-server mariadb-client apache2 php7.2 libapache2-mod-php7.2 php7.2-mysql php7.2-curl php7.2-gd php-memcache php7.2-recode php7.2-mbstring php-gettext php7.2-opcache php-apcu phpmyadmin -y
